...
# Install gcc 9.2
GMP_DOWNLOAD_URL=https://ftp.gwdg.de/pub/misc/gcc/infrastructure/gmp-6.1.0.tar.bz2
...
MPFR_DOWNLOAD_URL=https://ftp.gwdg.de/pub/misc/gcc/infrastructure/mpfr-3.1.4.tar.bz2
...
MPC_DOWNLOAD_URL=https://ftp.gwdg.de/pub/misc/gcc/infrastructure/mpc-1.0.3.tar.gz
...
# install gcc 9.2
GCC_VERSION="9.2.0"
GCC_DOWNLOAD_URL=https://ftp.gwdg.de/pub/misc/gcc/releases/gcc-${GCC_VERSION}/gcc-${GCC_VERSION}.tar.gz
